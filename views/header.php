<header>
  ...
  <?php else: ?>
    ...
    <h3 class="sixteen columns" style="text-align: center; margin-top: 5px;">Dossier de presse</h3>
    <h4 class="sixteen columns" style="text-align: center; margin-bottom: 20px">Un faire-part de naissance unique au monde</h4>
